...
async function main() {
  console.log('\n' + '#'.repeat(80));
  console.log('# screenshot-to-code Automated Browser Testing');
  ...
  try {
    ...
    const summaryPath = '/home/samuelrodda/repos/visual-to-code/results/phase1/browser-test-summary.json';
