...
- When a repo has not declared a preview adapter yet, bounded heuristic fallback should still key runtime identity off the inferred launch plan rather than collapsing every undeclared surface in that workspace onto one default preview lane.
