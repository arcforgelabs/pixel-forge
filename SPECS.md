...
- `REQ-E-011:` `Run Pixel Forge` must deterministically relaunch the latest mirror for the effective isolated workspace source instead of browsing project-wide mirror-history choices from the toolbar.
