...
func handleSessionShow(profile string, args []string) {
	...
	jsonData := map[string]interface{}{
		...
		"ownership":           inst.OwnershipMode().String(),
		"managed":             inst.IsCatoManaged(),
...
func handleSessionCurrent(profileArg string, args []string) {
	...
	jsonData := map[string]interface{}{
		...
		"status":    status,
		"ownership": session.NormalizeOwnership(instData.Ownership).String(),
		"managed":   session.IsCatoManagedOwnership(instData.Ownership),
	}
	...
	sb.WriteString(fmt.Sprintf("Owner:   %s\n", session.NormalizeOwnership(instData.Ownership).String()))
