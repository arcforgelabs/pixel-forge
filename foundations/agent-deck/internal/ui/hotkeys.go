...
const (
	...
	hotkeyCloneCheckpoint = "clone_checkpoint"
	hotkeyDelegatedFinish = "delegated_finish"
	hotkeyRepoCloseout    = "repo_closeout"
...
var hotkeyActionOrder = []string{
	...
	hotkeyCloneCheckpoint,
	hotkeyDelegatedFinish,
	hotkeyRepoCloseout,
	hotkeyCreateGroup,
	hotkeySearch,
	hotkeyHelp,
...
var defaultHotkeyBindings = map[string]string{
	...
	hotkeyCloneCheckpoint: "I",
	hotkeyDelegatedFinish: "A",
	hotkeyRepoCloseout:    "B",
	hotkeyCreateGroup:     "g",
	hotkeySearch:          "/",
	hotkeyHelp:            "?",
	hotkeySettings:        "S",
...
var hotkeyActionDefaultTriggers = map[string][]string{
	...
	hotkeyCloneCheckpoint: {"I", "shift+i"},
	hotkeyDelegatedFinish: {"A", "shift+a"},
	hotkeyRepoCloseout:    {"B", "shift+b"},
}
