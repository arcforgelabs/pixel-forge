...
var (
	...
	// Ownership badges
	OwnershipCatoBadgeStyle lipgloss.Style
	OwnershipUserBadgeStyle lipgloss.Style
	OwnershipBadgeSelStyle  lipgloss.Style
)
...
func initStyles() {
	...
	OwnershipCatoBadgeStyle = lipgloss.NewStyle().Foreground(ColorYellow).Bold(true)
	OwnershipUserBadgeStyle = lipgloss.NewStyle().Foreground(ColorComment)
	OwnershipBadgeSelStyle = SessionStatusSelStyle
	...
	ToolStyleCache = map[string]lipgloss.Style{
		...
		"openclaw": lipgloss.NewStyle().Foreground(ColorGreen),
	}
